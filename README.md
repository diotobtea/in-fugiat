...
[![Size](https://img.shields.io/bundlephobia/minzip/@diotobtea/in-fugiat?label=gzip&style=flat&colorA=000000&colorB=000000)](https://bundlephobia.com/package/@diotobtea/in-fugiat)
[![Version](https://img.shields.io/npm/v/@diotobtea/in-fugiat?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/@diotobtea/in-fugiat)
[![Downloads](https://img.shields.io/npm/dt/@diotobtea/in-fugiat.svg?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/@diotobtea/in-fugiat)
...
A react-internal `Fiber` provider. This component binds React children to the React Fiber tree. Call @diotobtea/in-fugiat hooks within this.
...
import { FiberProvider, useFiber } from '@diotobtea/in-fugiat'
...
import { type Fiber, useFiber } from '@diotobtea/in-fugiat'
...
```tsx
import * as React from 'react'
import { useContainer } from '@diotobtea/in-fugiat'
...
```tsx
import * as React from 'react'
import { useNearestChild } from '@diotobtea/in-fugiat'
...
```tsx
import * as React from 'react'
import { useNearestParent } from '@diotobtea/in-fugiat'
...
```tsx
import * as React from 'react'
import { useContextMap } from '@diotobtea/in-fugiat'
...
import * as ReactDOM from 'react-dom/client'
import { type ContextBridge, useContextBridge, FiberProvider } from '@diotobtea/in-fugiat'
...
```ts
import { type Fiber, traverseFiber } from '@diotobtea/in-fugiat'
